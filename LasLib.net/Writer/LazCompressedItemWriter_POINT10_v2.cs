...
//  CONTENTS:
//
//    Implementation of LasCompressedItemWriter for POINT10 items (version 2).
//
//  PROGRAMMERS:
//
...
{
	class LasCompressedItemWriter_POINT10_v2 : LasCompressedItemWriter
	{
		...
		public LasCompressedItemWriter_POINT10_v2(ArithmeticEncoder enc)
		{
			// set encoder
		...
		public override bool write(LasPoint item)
		{
			...
			uint m=LasCommon_v2.number_return_map[n, r];
			uint l=LasCommon_v2.number_return_level[n, r];
