...
{
	class LasCompressedItemReader_POINT10_v2 : LasCompressedItemReader
	{
		...
		public LasCompressedItemReader_POINT10_v2(ArithmeticDecoder dec)
		{
			// set decoder
		...
		public override void Read(LasPoint item)
		{
			...
			if(changed_values!=0)
			{
				...
				m=LasCommon_v2.number_return_map[n, r];
				l=LasCommon_v2.number_return_level[n, r];
