///////////////////////////////////////////////////////////////////////
/// File    : LasCompressedItemReader_BYTE_v1.cs
...
{
	class LasCompressedItemReader_BYTE_v1 : LasCompressedItemReader
	{
		public LasCompressedItemReader_BYTE_v1(ArithmeticDecoder dec, uint number)
		{
			// set decoder
