...
//  CONTENTS:
//
//    Implementation of LasCompressedItemWriter for BYTE items (version 2).
//
//  PROGRAMMERS:
//
...
{
	class LasCompressedItemWriter_BYTE_v2 : LasCompressedItemWriter
	{
		public LasCompressedItemWriter_BYTE_v2(ArithmeticEncoder enc, uint number)
		{
			// set encoder
